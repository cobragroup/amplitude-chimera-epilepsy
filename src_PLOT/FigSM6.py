...
fig.add_shape(dict(type="line",x0=2.5,y0=2.8,x1=2.5,y1=5,line=dict(color="black", dash='dashdot',width=2)))
fig.add_shape(dict(type="line",x0=3.5,y0=2.8,x1=3.5,y1=5,line=dict(color="black", dash='dashdot',width=2)))
