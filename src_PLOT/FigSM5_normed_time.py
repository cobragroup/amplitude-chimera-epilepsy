...
## offset of Seizure ## Seizure lasts for 1002 seconds () and starts at 3 mins
fig.add_shape(dict(type="line",x0=(3+(1002/60)),y0=1.5,x1=(3+(1002/60)),y1=6,line=dict(color="red", width=3)))
fig.add_annotation(dict(text="seizure offset",xref='x',yref='y',
        x=19.18,y=4.8,showarrow=False),font=dict(size=30, color="red",family="Times new Roman"))
